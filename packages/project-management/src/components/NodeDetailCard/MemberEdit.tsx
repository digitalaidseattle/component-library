...
import { Avatar, IconButton, MenuItem, Select, Stack, SxProps, Tooltip, Typography } from "@mui/material";
import { Profile } from "../../types";
import { ProgramContext } from "../ProgramContext";
import { InputEditProps } from "./types";

export const MemberEdit: React.FC<InputEditProps<string>> = ({ value, onChange }) => {
